!function(d) {
    ...
    var t, h = d.document, m = {
        ...
        var o = this, i = m.dir = m.dir || v, a = h.getElementsByTagName("head")[0], u = (r = "string" == typeof r ? [
            r
        ] : "function" == typeof r ? (t = r, [
            "all"
        ]) : r, d.jQuery && jQuery.fn.on && (o.each(r, function(t, e) {
        ...
        if (e = e || [], m.host = m.host || (i.match(/\/\/([\s\S]+?)\//) || [
            "//" + location.host + "/"
        ])[0], 0 === r.length || layui["layui.all"] && N[u]) return c(), o;
        var p, y = (y = (N[u] ? i + "modules/" : !/^\{\/\}/.test(o.modules[u]) && m.base || "") + (o.modules[u] || u) + ".js").replace(/^\{\/\}/, "");
        ...
        var o = this, e = h.getElementsByTagName("head")[0], i = h.createElement("link"), t = ((t = "string" == typeof n ? n : t) || r).replace(/\.|\//g, ""), a = i.id = "layuicss-" + t, u = "creating", l = 0;
        ...
        return "object" !== this.type(t) || o ? "object" != typeof t ? [
            r
        ] : (r.sort(function(t, e) {
            var r = t[o], n = e[o];
    ...
    n.prototype.onevent = function(t, e, r) {
        ...
        return r === s ? (delete (o.cache.event[t] || {})[u], o) : n ? (m.event[t] = m.event[t] || {}, u ? m.event[t][u] = [
            n
        ] : (m.event[t][u] = m.event[t][u] || [], m.event[t][u].push(n)), this) : (layui.each(m.event[t], function(t, e) {
...
!function(l) {
    ...
    var t, f = l.document, h = function(t) {
        ...
        for(var e = 0, n = "object" == typeof t ? layui.isArray(t) ? t : [
            t
        ] : (this.selector = t, f.querySelectorAll(t || null)); e < n.length; e++)this.push(n[e]);
    };
    (r.prototype = []).constructor = r, h.extend = function() {
        ...
        try {
            ...
            return layui.hint().error(e.errorText || [
                n + '="' + t + '"',
                "\n parseerror: " + o
            ].join("\n"), "error"), {};
        }
...
layui.define(function(e) {
    ...
    var r = document, u = "getElementById", c = "getElementsByTagName", a = "layui-disabled", t = function(e) {
        ...
        var t, i, n = this.config, r = n.groups = "groups" in n ? Number(n.groups) || 0 : 5, u = (n.layout = "object" == typeof n.layout ? n.layout : [
            "prev",
            "page",
            "next"
        ], n.count = Number(n.count) || 0, n.curr = Number(n.curr) || 1, n.limits = "object" == typeof n.limits ? n.limits : [
            10,
            20,
            30,
            40,
            50
        ], n.limit = Number(n.limit) || 10, n.pages = Math.ceil(n.count / n.limit) || 1, n.curr > n.pages ? n.curr = n.pages : n.curr < 1 && (n.curr = 1), r < 0 ? r = 1 : r > n.pages && (r = n.pages), n.prev = "prev" in n ? n.prev : "&#x4E0A;&#x4E00;&#x9875;", n.next = "next" in n ? n.next : "&#x4E0B;&#x4E00;&#x9875;", n.pages > r ? Math.ceil((n.curr + (1 < r ? 1 : 0)) / (0 < r ? r : 1)) : 1), l = {
        ...
        return [
            ...
            (i = [], layui.each(n.layout, function(e, a) {
                l[a] && i.push(l[a]);
            }), i.join("")),
            "</div>"
        ].join("");
        ...
        var a = this, t = a.config, i = a.type(), n = a.view(), i = (2 === i ? t.elem && (t.elem.innerHTML = n) : 3 === i ? t.elem.html(n) : r[u](t.elem) && (r[u](t.elem).innerHTML = n), t.jump && t.jump(t, e), r[u]("layui-laypage-" + t.index));
...
!function(i, p) {
    ...
    }, a = "laydate", x = "layui-this", k = "laydate-disabled", h = [
        100,
        2e5
    ], D = "layui-laydate-static", w = "layui-laydate-list", o = "laydate-selected", r = "layui-laydate-hint", y = "laydate-day-prev", m = "laydate-day-next", C = ".laydate-btns-confirm", M = "laydate-time-text", L = "laydate-btns-time", T = "layui-laydate-preview", E = "layui-laydate-main", S = "layui-laydate-shade", I = function(e) {
    ...
    s.formatArr = function(e) {
        ...
        var r = this, o = r.config, e = "static" === o.position, t = {
            year: "yyyy",
            month: "yyyy-MM",
            date: "yyyy-MM-dd",
            time: "HH:mm:ss",
        ...
        o.elem = lay(o.elem), o.eventElem = lay(o.eventElem), o.elem[0] && ("array" !== layui.type(o.theme) && (o.theme = [
            o.theme
        ]), o.fullPanel && ("datetime" !== o.type || o.range) && delete o.fullPanel, r.rangeStr = o.range ? "string" == typeof o.range ? o.range : "-" : "", r.rangeLinked = !(!o.range || !o.rangeLinked || "date" !== o.type && "datetime" !== o.type), r.autoCalendarModel = function() {
            var e = r.rangeLinked;
        ...
        }, r.autoCalendarModel.auto = r.rangeLinked && "auto" === o.rangeLinked, "array" === layui.type(o.range) && (r.rangeElem = [
            lay(o.range[0]),
            lay(o.range[1])
        ]), t[o.type] || (i.console && console.error && console.error("laydate type error:'" + o.type + "' is not supported"), o.type = "date"), o.format === t.date && (o.format = t[o.type] || t.date), r.format = s.formatArr(o.format), o.weekStart && !/^[0-6]$/.test(o.weekStart) && (t = r.lang(), o.weekStart = t.weeks.indexOf(o.weekStart), -1 === o.weekStart && (o.weekStart = 0)), r.EXP_IF = "", r.EXP_SPLIT = "", lay.each(r.format, function(e, t) {
            ...
            if ("number" == typeof o[t]) var i = o[t], l = new Date, l = r.newDate({
                ...
                minutes: e ? 59 : 0,
                seconds: e ? 59 : 0
            }).getTime(), e = new Date(i ? i < 864e5 ? l + 864e5 * i : i : l), a = [
                e.getFullYear(),
                e.getMonth() + 1,
                e.getDate()
            ], n = [
            ...
            else if ("string" == typeof o[t]) a = (o[t].match(/\d+-\d+-\d+/) || [
                ""
            ])[0].split("-"), n = (o[t].match(/\d+:\d+:\d+/) || [
                ""
            ])[0].split(":");
        ...
        var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position, y = r.elem = lay.elem("div", {
            ...
            "class": [
                ...
                (a = "", lay.each(o.theme, function(e, t) {
            ...
            var a = lay.elem("div", {
                ...
                }), n = lay.elem("span"), l = lay.elem("span"), t.appendChild(n), t.appendChild(l), t),
                ((n = lay.elem("i", {
            ...
            }), i = lay.elem("table"), l = lay.elem("thead"), r = lay.elem("tr");
            ...
            var t = (o.shortcuts[this.dataset.index] || {}).value || [], n = (layui.isArray(t) || (t = [
                t
            ]), o.type), t = (lay.each(t, function(e, t) {
                var a = [
                    o.dateTime,
                    r.endDate
                ][e];
                "time" === n && "date" !== layui.type(t) ? r.EXP_IF.test(t) && (t = (t.match(r.EXP_SPLIT) || []).slice(1), lay.extend(a, {
                    ...
                    minutes: 0 | t[2],
                    seconds: 0 | t[4]
                })) : lay.extend(a, r.systemDate("date" === layui.type(t) ? t : new Date(t))), "time" !== n && "datetime" !== n || (r[[
                    "startTime",
                    "endTime"
                ][e]] = {
                    hours: a.hours,
                    minutes: a.minutes,
                    seconds: a.seconds
                }), 0 === e ? r.startDate = lay.extend({}, a) : r.endState = !0, "year" === n || "month" === n || "time" === n ? r.listYM[e] = [
                    a.year,
                    a.month + 1
            ...
            /^#/.test(t) && (l = !0, g.push([
                ...
                -1 !== o.theme.indexOf("circle") ? "" : "#{{id}} .layui-this{background-color:{{theme}} !important;}"
        ...
        var t = this, a = (t.config, lay.elem("div", {
            "class": r
        }));
        ...
        return a ? t-- : t++, t < 0 && (t = 11, e--), 11 < t && (t = 0, e++), [
            e,
            t
        ];
        ...
        var t, o, d = this, s = (new Date, d.config), a = d.lang(), n = s.dateTime = s.dateTime || d.systemDate(), i = s.elem[0], l = (d.isInput(i), function() {
            if (d.rangeElem) {
                var e = [
                    d.rangeElem[0].val(),
                    d.rangeElem[1].val()
            ...
            i = (i.match(d.EXP_SPLIT) || []).slice(1), l = l || 0, s.range && (d[r[l]] = d[r[l]] || {}), lay.each(d.format, function(e, t) {
                ...
                i[e].length < t.length && (o = !0), /yyyy|y/.test(t) ? (a < h[0] && (a = h[0], o = !0), n.year = a) : /MM|M/.test(t) ? (a < 1 && (a = 1, o = !0), n.month = a - 1) : /dd|d/.test(t) ? (a < 1 && (a = 1, o = !0), n.date = a) : /HH|H/.test(t) ? (a < 0 && (o = (a = 0, true)), 23 < a && (a = 23, o = !0), n.hours = a, s.range && (d[r[l]].hours = a)) : /mm|m/.test(t) ? (a < 0 && (o = (a = 0, true)), 59 < a && (a = 59, o = !0), n.minutes = a, s.range && (d[r[l]].minutes = a)) : /ss|s/.test(t) && (a < 0 && (o = (a = 0, true)), 59 < a && (a = 59, o = !0), n.seconds = a, s.range && (d[r[l]].seconds = a));
            }), y(n);
        };
        ...
        return c(), "string" == typeof l && l ? d.EXP_IF.test(l) ? s.range ? (l = l.split(" " + d.rangeStr + " "), lay.each([
            s.dateTime,
            d.endDate
        ], function(e, t) {
            r(t, l[e], e);
        })) : r(n, l) : (d.hint(a.formatError[0] + (s.range ? s.format + " " + d.rangeStr + " " + s.format : s.format) + a.formatError[1]), o = !0) : l && "date" === layui.type(l) ? s.dateTime = d.systemDate(l) : (s.dateTime = d.systemDate(), delete d.startTime, delete d.endDate, c(), delete d.endTime), d.rangeElem && (c = [
            d.rangeElem[0].val(),
            d.rangeElem[1].val()
        ], m = [
            s.dateTime,
        ...
        return d.year < h[0] && (d.year = h[0], o.hint(y.invalidDate)), d.year > h[1] && (d.year = h[1], o.hint(y.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, d)), s.setFullYear(d.year, d.month, 1), i = (s.getDay() + (7 - n.weekStart)) % 7, l = v.getEndDate(d.month || 12, d.year), r = v.getEndDate(d.month + 1, d.year), lay.each(u, function(e, t) {
        ...
        }), lay(c[0]).attr("lay-ym", d.year + "-" + (d.month + 1)), lay(c[1]).attr("lay-ym", d.year + "-" + (d.month + 1)), "cn" === n.lang ? (lay(c[0]).attr("lay-type", "year").html(d.year + " 年"), lay(c[1]).attr("lay-type", "month").html(d.month + 1 + " 月")) : (lay(c[0]).attr("lay-type", "month").html(y.month[d.month]), lay(c[1]).attr("lay-type", "year").html(d.year)), m && (n.range ? !e && "init" === a || (o.listYM = [
            [
            ...
            year: s[0],
            month: s[1]
        }), 1 - t)) : o.calendar(null, 1 - t)), n.range || (u = [
            "hours",
            "minutes",
            "seconds"
        ], o.limit({
        ...
        var l, r, e, o, d = this, s = d.config, y = d.rangeLinked ? s.dateTime : [
            s.dateTime,
            d.endDate
        ][i], m = d.lang(), t = s.range && "date" !== s.type && "datetime" !== s.type, u = lay.elem("ul", {
            "class": w + " " + ({
                year: "laydate-year-list",
                month: "laydate-month-list",
                time: "laydate-time-list"
            })[n]
        }), a = d.elemHeader[i], c = lay(a[2]).find("span"), h = d.elemCont[i || 0], f = lay(h).find("." + w)[0], g = "cn" === s.lang, p = g ? "年" : "", v = d.listYM[i] || {}, D = [
            "hours",
            "minutes",
            "seconds"
        ], T = [
        ...
        return v[0] < 1 && (v[0] = 1), "year" === n ? (e = l = v[0] - 7, l < 1 && (e = l = 1), lay.each(new Array(15), function(e) {
            ...
            l == v[0] && lay(t).addClass(x), t.innerHTML = l + p, u.appendChild(t), d.limit({
                elem: lay(t),
                date: a,
                index: i,
                type: n
        ...
        }, s.range ? d[T] || (d[T] = "startTime" === T ? y : d.endDate) : d[T] = y, lay.each([
            24,
            60,
            60
        ], function(t, e) {
        ...
        }, c = lay(a[2]).find("." + M), o(), e.innerHTML = s.range ? [
            m.startTime,
            m.endTime
        ][i] : m.timeTips, lay(d.elemMain[i]).addClass("laydate-time-show"), c[0] && c.remove(), a[2].appendChild(e), lay(u).find("ol").each(function(t) {
            var a = this;
        ...
        var a = this, n = a.config, t = t || ("end" == e ? lay.extend({}, a.endDate, a.endTime) : n.range ? lay.extend({}, a.rangeLinked ? a.startDate : n.dateTime, a.startTime) : n.dateTime), t = v.parse(t, a.format, 1);
        ...
        a.isPreview && (e = lay(t.elem).find("." + T), a = !a.range || (t.rangeLinked ? t.endState : t.endDate) ? t.parse() : "", e.html(a), e.html() && (e.css({
            color: "#16b777"
        }), setTimeout(function() {
            e.css({
                color: "#777"
        ...
        l.range && !i.endState && lay(i.footer).find(C).addClass(k), r = r && i.newDate({
            ...
            var a = lay(t).attr("lay-ymd").split("-"), a = i.newDate({
                year: a[0],
                month: a[1] - 1,
                date: a[2]
            }).getTime();
        ...
        return lay.each([
            ...
            i,
            l
        ], "change" === t && a.renderAdditional(), "function" == typeof n[t || "done"] && n[t || "done"].apply(n, e), a;
        ...
        e.hasClass(k) || (i = (n = this).config, t = a, n.rangeLinked && (n.endState || !n.startDate ? (a = 0, n.endState = !1, n.endDate = {}) : (a = 1, n.endState = !0)), l = n.thisDateTime(a), lay(n.elem).find("td"), e = {
            ...
            month: (0 | e[1]) - 1,
            date: 0 | e[2]
        }, lay.extend(l, e), i.range ? (lay.each([
            "startTime",
            "endTime"
        ], function(e, t) {
            n[t] = n[t] || {
        ...
        var a = this, n = a.config, i = a.lang(), l = n.dateTime, r = "static" === n.position, o = {
            ...
            clear: function() {
                r && (lay.extend(l, a.firstDate), a.calendar()), n.range && (delete n.dateTime, delete a.endDate, delete a.startTime, delete a.endTime), a.setValue(""), a.done(null, "onClear").done([
                    "",
                    {},
                    {}
                ]).remove();
        ...
        var i = this, l = i.config, r = i.thisDateTime(n), o = l.range && ("year" === l.type || "month" === l.type), d = i.elemCont[n || 0], s = i.listYM[n], e = function(e) {
        ...
        lay(i.elem).on("click", function(e) {
            ...
            lay(e[0]).on("click", function(e) {
                ...
                a && (a = a.split("-"), i.listYM[n] = [
                    0 | a[0],
                    0 | a[1]
                ], i.list(t, n), lay(i.footer).find("." + L).addClass(k));
...
!function(e, t) {
    ...
    var f = [], g = T.document, c = f.slice, O = f.concat, R = f.push, P = f.indexOf, B = {}, W = B.toString, m = B.hasOwnProperty, y = {}, e = "1.12.4", C = function(e, t) {
    ...
    C.fn = C.prototype = {
        ...
        makeArray: function(e, t) {
            t = t || [];
            return null != e && (U(Object(e)) ? C.merge(t, "string" == typeof e ? [
                e
            ] : e) : R.call(t, e)), t;
        },
    ...
    var e = function(M) {
        ...
        function fe(e, t) {
            var n = t && e, r = n && 1 === e.nodeType && 1 === t.nodeType && (~t.sourceIndex || -2147483648) - (~e.sourceIndex || -2147483648);
            if (r) return r;
            if (n) {
                ...
                CHILD: function(h, e, t, g, m) {
                    ...
                    return 1 === g && 0 === m ? function(e) {
                        ...
                        if (c) {
                            ...
                            } else if (!1 === (p = d ? s = (r = (i = (o = (a = e)[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === S && r[1] : p)) for(; (a = ++s && a && a[l] || (p = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++p || (d && ((i = (o = a[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [
                                S,
                                p
                            ]), a !== e)););
        ...
        function ye(p, h, g, m, y, e) {
            return m && !m[k] && (m = ye(m)), y && !y[k] && (y = ye(y, e)), q(function(e, t, n, r) {
                var i, o, a, s = [], u = [], l = t.length, c = e || function(e, t, n) {
                    ...
                    n
                ] : n, []), f = !p || !e && h ? c : me(c, s, p, n, r), d = g ? y || (e ? p : l || m) ? [] : t : f;
        ...
        return pe.prototype = b.filters = b.pseudos, b.setFilters = new pe, w = H.tokenize = function(e, t) {
            ...
            if (!a) {
                for(n = (t = t || w(e)).length; n--;)((a = function f(e) {
                    ...
                    ]; s < i; s++)if (t = b.relative[e[s].type]) c = [
                        he(ge(c), t)
                    ];
                    else {
    ...
    }(T), r = (C.find = e, C.expr = e.selectors, C.expr[":"] = C.expr.pseudos, C.uniqueSort = C.unique = e.uniqueSort, C.text = e.getText, C.isXMLDoc = e.isXML, C.contains = e.contains, function(e, t, n) {
    ...
    var Q, Z = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ee = ((C.fn.init = function(e, t, n) {
        ...
        if (!(r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [
            ...
            e,
            null
        ] : Z.exec(e)) || !r[1] && t) return (!t || t.jquery ? t || n : this.constructor(t)).find(e);
        if (r[1]) {
    ...
    }).prototype = C.fn, Q = C(g), /^(?:parents|prev(?:Until|All))/), te = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    for(ie in C.Callbacks = function(r) {
                    ...
                    return C.Deferred(function(r) {
                        C.each(o, function(e, t) {
                            ...
                            s[t[1]](function() {
                                ...
                                e && C.isFunction(e.promise) ? e.promise().progress(r.notify).done(r.resolve).fail(r.reject) : r[t[0] + "With"](this === a ? r.promise() : this, n ? [
                                    e
                                ] : arguments);
                            });
                        }), i = null;
        ...
        ready: function(e) {
            (!0 === e ? --C.readyWait : C.isReady) || (C.isReady = !0) !== e && 0 < --C.readyWait || (re.resolveWith(g, [
                C
        ...
        if (v(e)) {
            ...
            if (a[s]) {
                ...
                (n || (delete a[s].data, le(a[s]))) && (o ? C.cleanData([
                    e
                ], !0) : y.deleteExpando || a != a.window ? delete a[s] : a[s] = undefined);
            }
        }
    }
    C.extend({
    ...
    var e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, de = new RegExp("^(?:([+-])=|)(" + e + ")([a-z%]*)$", "i"), s = [
        "Top",
        "Right",
        "Bottom",
        "Left"
    ...
    }, ge = /^(?:checkbox|radio)$/i, me = /<([\w:-]+)/, ye = /^$|\/(?:java|ecma)script/i, ve = /^\s+/, xe = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";
    function be(e) {
    ...
    function Ne(e, t, n, r, i) {
        for(var o, a, s, u, l, c, f, d = e.length, p = be(t), h = [], g = 0; g < d; g++)if ((a = e[g]) || 0 === a) {
            if ("object" === C.type(a)) C.merge(h, a.nodeType ? [
                a
            ] : a);
            else if (Te.test(a)) {
                for(u = u || p.appendChild(t.createElement("div")), l = (me.exec(a) || [
                    "",
                    ""
                ])[1].toLowerCase(), f = x[l] || x._default, u.innerHTML = f[1] + C.htmlPrefilter(a) + f[2], o = f[0]; o--;)u = u.lastChild;
        ...
        for(u && p.removeChild(u), y.appendChecked || C.grep(b(h, "input"), Ee), g = 0; a = h[g++];)if (r && -1 < C.inArray(a, r)) i && i.push(a);
    ...
    var De = /^(?:input|select|textarea)$/i, je = /^key/, Le = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, He = /^(?:focusinfocus|focusoutblur)$/, qe = /^([^.]*)(?:\.(.+)|)/;
    function _e() {
        return !0;
    }
    function u() {
    ...
    C.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            }).elem = e), a = (t = (t || "").match(E) || [
                ""
            ]).length; a--;)f = p = (d = qe.exec(t[a]) || [])[1], d = (d[2] || "").split(".").sort(), f && (u = C.event.special[f] || {}, f = (i ? u.delegateType : u.bindType) || f, u = C.event.special[f] || {}, p = C.extend({
                type: f,
                origType: p,
                data: r,
                handler: n,
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (c = m.events)) {
                for(l = (t = (t || "").match(E) || [
                    ""
                ]).length; l--;)if (p = g = (s = qe.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function(e, t, n, r) {
            var i, o, a, s, u, l, c = [
                n || g
            ], f = m.call(e, "type") ? e.type : e, d = m.call(e, "namespace") ? e.namespace.split(".") : [], p = u = n = n || g;
            if (3 !== n.nodeType && 8 !== n.nodeType && !He.test(f + C.event.triggered) && (-1 < f.indexOf(".") && (f = (d = f.split(".")).shift(), d.sort()), o = f.indexOf(":") < 0 && "on" + f, (e = e[C.expando] ? e : new C.Event(f, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = d.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = undefined, e.target || (e.target = n), t = null == t ? [
                e
            ] : C.makeArray(t, [
                e
            ]), s = C.event.special[f] || {}, r || !s.trigger || !1 !== s.trigger.apply(n, t))) {
        ...
        handlers: function(e, t) {
            ...
            if (s && u.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1)) {
                for(; u != this; u = u.parentNode || this)if (1 === u.nodeType && (!0 !== u.disabled || "click" !== e.type)) {
                    for(r = [], n = 0; n < s; n++)r[i = (o = t[n]).selector + " "] === undefined && (r[i] = o.needsContext ? -1 < C(i, this).index(u) : C.find(i, this, null, [
                        u
                    ]).length), r[i] && r.push(o);
                    r.length && a.push({
                        elem: u,
    ...
    var Oe = / jQuery\d+="(?:null|\d+)"/g, Re = new RegExp("<(?:" + xe + ")[\\s/>]", "i"), Pe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, Be = /<script|<style|<link/i, We = /checked\s*(?:[^=]|=\s*.checked.)/i, Ie = /^true\/(.*)/, $e = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ze = be(g).appendChild(g.createElement("div"));
    function Xe(e, t) {
    ...
    C.extend({
        ...
        html: function(e) {
            return d(this, function(e) {
                ...
                if ("string" == typeof e && !Be.test(e) && (y.htmlSerialize || !Re.test(e)) && (y.leadingWhitespace || !ve.test(e)) && !x[(me.exec(e) || [
                    "",
                    ""
                ])[1].toLowerCase()]) {
                    e = C.htmlPrefilter(e);
    ...
    var dt = /alpha\([^)]*\)/i, pt = /opacity\s*=\s*([^)]*)/i, ht = /^(none|table(?!-c[ea]).+)/, gt = new RegExp("^(" + e + ")(.*)$", "i"), mt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, yt = {
    ...
    function A(i, e, t) {
        var n, o, r, a, s, u, l, c = 0, f = A.prefilters.length, d = C.Deferred().always(function() {
            ...
            return d.notifyWith(i, [
                h,
                t,
                e
            ]), t < 1 && r ? e : (d.resolveWith(i, [
                h
            ]), !1);
        }, h = d.promise({
            elem: i,
        ...
        for(r in m)if (s = y[a = C.camelCase(r)], u = m[r], C.isArray(u) && (s = u[1], u = m[r] = u[0]), r !== a && (m[a] = u, delete m[r]), (l = C.cssHooks[a]) && "expand" in l) for(r in u = l.expand(u), delete m[a], u)r in m || (m[r] = u[r], y[r] = s);
        else y[a] = s;
    ...
    C.Animation = C.extend(A, {
        ...
        tweener: function(e, t) {
            for(var n, r = 0, i = (e = C.isFunction(e) ? (t = e, [
                "*"
            ]) : e.match(E)).length; r < i; r++)n = e[r], A.tweeners[n] = A.tweeners[n] || [], A.tweeners[n].unshift(t);
        },
        prefilters: [
            function(t, e, n) {
                ...
                for(r in n.queue || (null == (s = C._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, u = s.empty.fire, s.empty.fire = function() {
                    ...
                    d.overflowX,
                    d.overflowY
                ], "inline" === ("none" === (l = C.css(t, "display")) ? C._data(t, "olddisplay") || Ze(t.nodeName) : l) && "none" === C.css(t, "float") && (y.inlineBlockNeedsLayout && "inline" !== Ze(t.nodeName) ? d.zoom = 1 : d.display = "inline-block")), n.overflow && (d.overflow = "hidden", y.shrinkWrapBlocks() || c.always(function() {
                ...
                else for(r in h ? "hidden" in h && (p = h.hidden) : h = C._data(t, "fxshow", {}), o && (h.hidden = !p), p ? C(t).show() : c.done(function() {
                    C(t).hide();
                }), c.done(function() {
    ...
    var q = T.location, Pt = C.now(), Bt = /\?/, Wt = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g, It = (C.parseJSON = function(e) {
    ...
    }, /#.*$/), $t = /([?&])_=[^&]*/, zt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Xt = /^(?:GET|HEAD)$/, Ut = /^\/\//, Vt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Yt = {}, Jt = {}, Gt = "*/".concat("*"), Kt = q.href, _ = Vt.exec(Kt.toLowerCase()) || [];
    function Qt(o) {
        return function(e, t) {
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            if (m.promise(b).complete = y.add, b.success = b.done, b.error = b.fail, p.url = ((e || p.url || Kt) + "").replace(It, "").replace(Ut, _[1] + "//"), p.type = t.method || t.type || p.method || p.type, p.dataTypes = C.trim(p.dataType || "*").toLowerCase().match(E) || [
                ""
            ], null == p.crossDomain && (e = Vt.exec(p.url.toLowerCase()), p.crossDomain = !(!e || e[1] === _[1] && e[2] === _[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (_[3] || ("http:" === _[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = C.param(p.data, p.traditional)), Zt(Yt, p, t, b), 2 === x) return b;
            ...
            if (d = Zt(Jt, p, t, b)) {
                if (b.readyState = 1, f && g.trigger("ajaxSend", [
                    b,
                    p
                ]), 2 === x) return b;
            ...
            function s(e, t, n, r) {
                ...
                2 !== x && (x = 2, c && T.clearTimeout(c), d = undefined, l = r || "", b.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (a = function(e, t, n) {
                ...
                }(p, b, n)), a = tn(p, a, b, r), r ? (p.ifModified && ((n = b.getResponseHeader("Last-Modified")) && (C.lastModified[u] = n), (n = b.getResponseHeader("etag")) && (C.etag[u] = n)), 204 === e || "HEAD" === p.type ? s = "nocontent" : 304 === e ? s = "notmodified" : (s = a.state, i = a.data, r = !(o = a.error))) : (o = s, !e && s || (s = "error", e < 0 && (e = 0))), b.status = e, b.statusText = (t || s) + "", r ? m.resolveWith(h, [
                    i,
                    s,
                    b
                ]) : m.rejectWith(h, [
                    ...
                    s,
                    o
                ]), b.statusCode(v), v = undefined, f && g.trigger(r ? "ajaxSuccess" : "ajaxError", [
                    b,
                    p,
                    r ? i : o
                ]), y.fireWith(h, [
    ...
    var pn = [], hn = /(=)\?(?=&|$)|\?\?/, gn = (C.ajaxSetup({
        ...
        return r ? [
            ...
            e
        ], t, n), n && n.length && C(n).remove(), C.merge([], r.childNodes));
    }, C.fn.load);
    function mn(e) {
    ...
    return C.fn.load = function(e, t, n) {
        ...
        setOffset: function(e, t, n) {
            ...
            "static" === s && (e.style.position = "relative"), o = u.offset(), r = C.css(e, "top"), a = C.css(e, "left"), s = ("absolute" === s || "fixed" === s) && -1 < C.inArray("auto", [
                r,
                a
            ]) ? (i = (s = u.position()).top, s.left) : (i = parseFloat(r) || 0, parseFloat(a) || 0), null != (t = C.isFunction(t) ? t.call(e, n, C.extend({}, o)) : t).top && (l.top = t.top - o.top + i), null != t.left && (l.left = t.left - o.left + s), "using" in t ? t.using.call(e, l) : u.css(l);
        }
    }, C.fn.extend({
        offset: function(t) {
...
!function(p) {
    ...
    var m, c, e, n = p.layui && layui.define, f = {
        ...
        path: f.getPath,
        config: function(e, t) {
            return h.cache = f.config = m.extend({}, f.config, e = e || {}), h.path = f.config.path || h.path, "string" == typeof e.extend && (e.extend = [
                e.extend
            ]), f.config.path && h.ready(), e.extend && (n ? layui.addcss("modules/layer/" + e.extend) : f.link("css/" + e.extend)), this;
        },
        ready: function(e) {
        ...
        return a.zIndex = o, t([
            a.shade ? '<div class="' + d.SHADE + '" id="' + d.SHADE + n + '" times="' + n + '" style="z-index:' + (o - 1) + '; "></div>' : "",
            '<div class="' + d[0] + " layui-layer-" + f.type[a.type] + (0 != a.type && 2 != a.type || a.shade ? "" : " layui-layer-border") + " " + (a.skin || "") + '" id="' + d[0] + n + '" type="' + f.type[a.type] + '" times="' + n + '" showtime="' + a.time + '" conType="' + (e ? "object" : "string") + '" style="z-index: ' + o + "; width:" + a.area[0] + ";height:" + a.area[1] + ";position:" + (a.fixed ? "fixed;" : "absolute;") + '">' + (e && 2 != a.type ? "" : s) + "<div" + (a.id ? ' id="' + a.id + '"' : "") + ' class="layui-layer-content' + (0 == a.type && -1 !== a.icon ? " layui-layer-padding" : "") + (3 == a.type ? " layui-layer-loading" + a.icon : "") + '">' + (n = [
                "layui-icon-tips",
                "layui-icon-success",
                "layui-icon-error",
                "layui-icon-question",
            ...
            ], o = "layui-anim layui-anim-rotate layui-anim-loop", 0 == a.type && -1 !== a.icon ? '<i class="layui-layer-face layui-icon ' + ((i = 16 == a.icon ? "layui-icon layui-icon-loading " + o : i) || n[a.icon] || n[0]) + '"></i>' : 3 == a.type ? (i = [
                "layui-icon-loading",
                "layui-icon-loading-1"
            ], 2 == a.icon ? '<div class="layui-layer-loading-2 ' + o + '"></div>' : '<i class="layui-layer-loading-icon layui-icon ' + (i[a.icon] || i[0]) + " " + o + '"></i>') : "") + ((1 != a.type || !e) && a.content || "") + '</div><div class="layui-layer-setwin">' + (n = [], l && (n.push('<span class="layui-layer-min"></span>'), n.push('<span class="layui-layer-max"></span>')), a.closeBtn && n.push('<span class="layui-icon layui-icon-close ' + [
                d[7],
                d[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2")
            ].join(" ") + '"></span>'), n.join("")) + "</div>" + (a.btn ? function() {
                var e = "";
                "string" == typeof a.btn && (a.btn = [
                    a.btn
                ]);
        ...
        if (!a.id || !m("." + d[0]).find("#" + a.id)[0]) {
            switch(a.removeFocus && document.activeElement.blur(), "string" == typeof a.area && (a.area = "auto" === a.area ? [
                "",
                ""
            ] : [
                a.area,
                ""
            ]), a.shift && (a.anim = a.shift), 6 == h.ie && (a.fixed = !1), a.type){
                case 0:
                    a.btn = "btn" in a ? a.btn : f.btn[0], h.closeAll("dialog");
                    break;
                case 2:
                    var r = a.content = s ? a.content : [
                        a.content || "",
                        "auto"
                    ];
                ...
                case 4:
                    s || (a.content = [
                        a.content,
                        "body"
                    ]), a.follow = a.content[1], a.content = a.content[0] + '<i class="layui-layer-TipsG"></i>', delete a.title, a.tips = "object" == typeof a.tips ? a.tips : [
                        a.tips,
                        !0
        ...
        var t = this.config, i = m("#" + d[0] + e), n = ("" === t.area[0] && 0 < t.maxWidth && (h.ie && h.ie < 8 && t.btn && i.width(i.innerWidth()), i.outerWidth() > t.maxWidth && i.width(t.maxWidth)), [
            i.innerWidth(),
            i.innerHeight()
        ...
        var e = this, t = e.config, i = e.layero, n = [
            i.outerWidth(),
            i.outerHeight()
        ...
        var e = this.config, t = this.layero, i = [
            t.outerWidth(),
            t.outerHeight()
        ], n = m(e.follow), a = {
        ...
        var n = this, a = n.config, e = m(document), o = n.layero, r = [
            "LAY_MOVE_DICT",
            "LAY_RESIZE_DICT"
        ], t = o.find(a.move), i = o.find(".layui-layer-resize");
        return a.move && t.css("cursor", "move"), t.on("mousedown", function(e) {
            var t, i;
            e.button || (t = m(this), i = {}, a.move && (i.layero = o, i.config = a, i.offset = [
                e.clientX - parseFloat(o.css("left")),
                e.clientY - parseFloat(o.css("top"))
            ], t.data(r[0], i), f.eventMoveElem = t, f.moveElem.css("cursor", "move").show()), e.preventDefault());
        }), i.on("mousedown", function(e) {
            var t = m(this), i = {};
            a.resize && (i.layero = o, i.config = a, i.offset = [
                e.clientX,
                e.clientY
            ], i.index = n.index, i.area = [
                o.outerWidth(),
                o.outerHeight()
            ], t.data(r[1], i), f.eventResizeElem = t, f.moveElem.css("cursor", "se-resize").show()), e.preventDefault();
        ...
        var t, i, n;
        e && (t = h.getChildFrame("html", e).outerHeight(), i = (e = m("#" + d[0] + e)).find(d[1]).outerHeight() || 0, n = e.find("." + d[6]).outerHeight() || 0, e.css({
            height: t + i + n
        }), e.find("iframe").css({
            height: t
        }));
        ...
        var e = m("#" + d[0] + e), n = e.find(".layui-layer-content"), a = e.attr("type"), o = e.find(d[1]).outerHeight() || 0, s = e.find("." + d[6]).outerHeight() || 0;
        e.attr("minLeft");
        a !== f.type[3] && a !== f.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - o - s <= 64 && (t.height = 64 + o + s)), e.css(t), s = e.find("." + d[6]).outerHeight() || 0, a === f.type[2] ? e.find("iframe").css({
        ...
        var s, e, l = (t = m("." + d[0]).find("#" + a).closest("." + d[0]))[0] ? (a = t.attr("times"), t) : m("#" + d[0] + a), r = l.attr("type"), t = l.data() || {}, i = {
    ...
    h.prompt = function(i, n) {
        ...
        var o = {};
        if ((n = n || {}).photos) {
            var t = !("string" == typeof n.photos || n.photos instanceof m), i = t ? n.photos : {}, s = i.data || [], l = i.start || 0, r = (o.imgIndex = 1 + (0 | l), n.img = n.img || "img", n.success);
            ...
            var t = s[l].src, d = function(e) {
                ...
                a && (n.anim = -1), o.index = h.open(m.extend({
                    ...
                    area: (e = [
                        ...
                        m(p).width() - 100,
                        m(p).height() - 100
                    ], !n.full && (e[0] > t[0] || e[1] > t[1]) && ((t = [
                        e[0] / t[0],
                        e[1] / t[1]
                    ])[1] < t[0] ? (e[0] = e[0] / t[0], e[1] = e[1] / t[0]) : t[0] < t[1] && (e[0] = e[0] / t[1], e[1] = e[1] / t[1])), [
                        e[0] + "px",
                        e[1] + "px"
                    ]),
                    title: !1,
                    ...
                    content: '<div class="layui-layer-phimg"><img src="' + s[l].src + '" alt="' + i + '" layer-pid="' + s[l].pid + '">' + (t = [
                        ...
                        '<a href="' + s[l].src + '" target="_blank">查看原图</a>',
                        "</div>",
                        "</div>"
    ...
    var s = layui.$, a = layui.hint(), o = {
        fixbar: function(i) {
            var o, e, t, n, a = "layui-fixbar", r = s(document), l = (i = s.extend(!0, {
                ...
                margin: 160,
                duration: 320
            }, i), s(i.target)), c = i.scroll ? s(i.scroll) : s("body" === i.target ? r : l), u = (i["default"] && (i.bar1 && i.bars.push({
                type: "bar1",
        ...
        countdown: function(e, t, n) {
            var i = this, o = "function" == typeof t, a = new Date(e).getTime(), r = new Date(!t || o ? (new Date).getTime() : t).getTime(), a = a - r, l = [
                Math.floor(a / 864e5),
    ...
    k.prototype.config = {
        ...
        var l = this, d = l.config, t = s("body"), n = function() {
            ...
            return layui.each(e, function(e, i) {
                var t, n = i.child && 0 < i.child.length, a = ("isSpreadItem" in i ? i : d).isSpreadItem, l = (o = i.title, l = i.templet || d.templet, o = l ? "function" == typeof l ? l(i) : c(l).render(i) : o), o = (n && (i.type = i.type || "parent"), i.type ? ({
                    group: "group",
                    parent: "parent",
                    "-": "-"
                })[i.type] || "parent" : "");
                ("-" === o || i.title || i.id || n) && ((l = s([
                    "<li" + (t = {
                    ...
                    (t = "href" in i ? '<a href="' + i.href + '" target="' + (i.target || "_self") + '">' + l + "</a>" : l, n ? '<div class="' + h + '">' + t + ("parent" === o ? '<i class="layui-icon layui-icon-right"></i>' : "group" === o && d.isAllowSpread ? '<i class="layui-icon layui-icon-' + (a ? "up" : "down") + '"></i>' : "") + "</div>" : '<div class="' + h + '">' + t + "</div>"),
                    "</li>"
                ].join(""))).data("item", i), n && (a = s('<div class="layui-panel layui-menu-body-panel"></div>'), t = s("<ul></ul>"), "parent" === o ? (a.append(u(t, i.child)), l.append(a)) : l.append(u(t, i.child))), r.append(l));
            }), r;
        }, a = [
            '<div class="layui-dropdown layui-border-box layui-panel layui-anim layui-anim-downbit" lay-id="' + d.id + '">',
            "</div>"
        ].join("");
        ...
        var i = s(this), t = i.parents(".layui-menu").eq(0), n = i.hasClass(u) || i.hasClass(g), a = t.attr("lay-filter") || t.attr("id"), l = lay.options(this);
        ...
        var t = s.extend([], arguments), n = (t[2] = "reloadData", new RegExp("^(" + [
            "data",
            "templet",
            "content"
        ].join("|") + ")$"));
...
layui.define([
    ...
    }, t = "slider", v = "layui-disabled", x = "layui-slider-bar", b = "layui-slider-wrap", T = "layui-slider-wrap-btn", w = "layui-slider-tips", M = "layui-slider-input-txt", L = "layui-slider-hover", i = function(e) {
        var i = this;
    ...
    i.prototype.config = {
        ...
        g.extend(n, c.options(e[0])), n.step < 1 && (n.step = 1), n.max < n.min && (n.max = n.min + n.step), n.range ? (n.value = "object" == typeof n.value ? n.value : [
            n.min,
            n.value
        ], e = Math.min(n.value[0], n.value[1]), i = Math.max(n.value[0], n.value[1]), n.value[0] = e > n.min ? e : n.min, n.value[1] = i > n.min ? i : n.min, n.value[0] = n.value[0] > n.max ? n.max : n.value[0], n.value[1] = n.value[1] > n.max ? n.max : n.value[1], i = Math.floor((n.value[0] - n.min) / (n.max - n.min) * 100), t = (s = Math.floor((n.value[1] - n.min) / (n.max - n.min) * 100)) - i + "%", i += "%", s += "%") : ("object" == typeof n.value && (n.value = Math.min.apply(null, n.value)), n.value < n.min && (n.value = n.min), n.value > n.max && (n.value = n.max), t = Math.floor((n.value - n.min) / (n.max - n.min) * 100) + "%");
        ...
        n.input && !n.range && (e = g('<div class="layui-slider-input layui-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="layui-icon layui-icon-up"></i><i class="layui-icon layui-icon-down"></i></div></div>'), t.css("position", "relative"), t.append(e), t.find("." + M).children("input").val(n.value), "vertical" === n.type ? e.css({
            ...
            var e = "vertical" === n.type ? n.height : a.elemTemp[0].offsetWidth, i = a.elemTemp.find("." + b), t = ("vertical" === n.type ? e - g(this).parent()[0].offsetTop - i.height() : g(this).parent()[0].offsetLeft) / e * 100, i = g(this).parent().data("value"), e = n.setTips ? n.setTips(i) : i;
        ...
        var o = this, r = o.config, u = o.elemTemp, d = function() {
        ...
        }, c = u.find("." + b), m = u.next(".layui-slider-input"), v = m.children("." + M).children("input").val(), p = 100 / ((r.max - r.min) / Math.ceil(r.step)), f = function(e, i, t) {
            ...
            var a, n = h(c[0].offsetLeft), l = r.range ? h(c[1].offsetLeft) : 0, s = ("vertical" === r.type ? (u.find("." + w).css({
                bottom: e + "%",
                "margin-bottom": "20px"
            }), n = h(d() - c[0].offsetTop - c.height()), l = r.range ? h(d() - c[1].offsetTop - c.height()) : 0) : u.find("." + w).css("left", e + "%"), n = 100 < n ? 100 : n, l = 100 < l ? 100 : l, Math.min(n, l)), n = Math.abs(n - l), l = ("vertical" === r.type ? u.find("." + x).css({
                height: n + "%",
                bottom: s + "%"
            }) : u.find("." + x).css({
                width: n + "%",
            ...
            v = l, m.children("." + M).children("input").val(v), c.eq(i).data("value", l), u.find("." + w).html(r.setTips ? r.setTips(l) : l), r.range && (a = [
                c.eq(0).data("value"),
                c.eq(1).data("value")
            ])[0] > a[1] && a.reverse(), o.value = r.range ? a : l, r.change && r.change(o.value), "done" === t && r.done && r.done(o.value);
        }, h = function(e) {
...
layui.define([
    ...
    d.prototype.config = {
        ...
        var o = m([
            ...
            "<span " + ("rgb" == i.format && i.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : "") + ">",
            '<span class="layui-colorpicker-trigger-span" ',
            'lay-type="' + ("rgb" == i.format ? i.alpha ? "rgba" : "torgb" : "") + '" ',
            'style="' + (o = "", i.color ? (o = i.color, 3 < (i.color.match(/[0-9]{1,3}/g) || []).length && (i.alpha && "rgb" == i.format || (o = "#" + F(Y(L(i.color))))), "background: " + o) : o) + '">',
            '<i class="layui-icon layui-colorpicker-trigger-i ' + (i.color ? x : P) + '"></i>',
            "</span>",
            "</span>",
            "</div>"
        ].join("")), r = i.elem = m(i.elem);
        ...
        var o, e = this, i = e.config, r = e.elemColorBox[0], t = e.elemPicker = m([
            ...
            i.predefine ? (o = [
                ...
                o.push([
                    '<div class="layui-colorpicker-pre' + (3 < (i.match(/[0-9]{1,3}/g) || []).length ? " layui-colorpicker-pre-isalpha" : "") + '">',
        ...
        var e, i = this, o = (i.config, i.elemColorBox.find("." + C)), r = i.elemPicker.find("." + T), t = o[0].style.backgroundColor;
        ...
        var n = this, l = n.config, c = n.elemColorBox.find("." + C), a = c.attr("lay-type"), s = n.elemPicker.find(".layui-colorpicker-side"), e = n.elemPicker.find("." + B), d = n.elemPicker.find("." + I), r = n.elemPicker.find("." + M), f = n.elemPicker.find("." + D), u = n.elemPicker.find("." + E), g = e[0].offsetTop / 180 * 360, h = 100 - (r[0].offsetTop + 3) / 180 * 100, p = (r[0].offsetLeft + 3) / 260 * 100, v = Math.round(u[0].offsetLeft / 280 * 100) / 100, b = n.elemColorBox.find("." + w), i = n.elemPicker.find(".layui-colorpicker-pre").children("div"), y = function(e, i, o, r) {
            n.select(e, i, o);
            var t = j({
                h: e,
                s: i,
                ...
                s: i,
                b: o
            }), i = n.elemPicker.find("." + T).find("input");
            b.addClass(x).removeClass(P), c[0].style.background = "rgb(" + t.r + ", " + t.g + ", " + t.b + ")", "torgb" === a ? i.val("rgb(" + t.r + ", " + t.g + ", " + t.b + ")") : "rgba" === a ? (u.css("left", 280 * r), i.val("rgba(" + t.r + ", " + t.g + ", " + t.b + ", " + r + ")"), c[0].style.background = "rgba(" + t.r + ", " + t.g + ", " + t.b + ", " + r + ")", f[0].style.background = "linear-gradient(to right, rgba(" + t.r + ", " + t.g + ", " + t.b + ", 0), rgb(" + t.r + ", " + t.g + ", " + t.b + "))") : i.val("#" + e), l.change && l.change(n.elemPicker.find("." + T).find("input").val());
        }, o = m([
        ...
        e.on("mousedown", function(e) {
            ...
            var i = e.clientY - m(this).offset().top, i = (i = (i = i < 0 ? 0 : i) > this.offsetHeight ? this.offsetHeight : i) / 180 * 360;
            ...
            layui.stope(e), k(function(e) {
                var i = n + (e.clientY - c), o = l + (e.clientX - a), r = d[0].offsetHeight - 3, t = d[0].offsetWidth - 3, t = ((o = t < (o = o < -3 ? -3 : o) ? t : o) + 3) / 260 * 100, o = 100 - ((i = r < (i = i < -3 ? -3 : i) ? r : i) + 3) / 180 * 100;
                y(g, p = t, h = o, v), e.preventDefault();
            }), e.preventDefault();
        }), d.on("mousedown", function(e) {
            var i = e.clientY - m(this).offset().top - 3 + H.scrollTop(), o = e.clientX - m(this).offset().left - 3 + H.scrollLeft(), o = ((i = i < -3 ? -3 : i) > this.offsetHeight - 3 && (i = this.offsetHeight - 3), ((o = (o = o < -3 ? -3 : o) > this.offsetWidth - 3 ? this.offsetWidth - 3 : o) + 3) / 260 * 100), i = 100 - (i + 3) / 180 * 100;
            ...
            var i = e.clientX - m(this).offset().left, i = ((i = i < 0 ? 0 : i) > this.offsetWidth && (i = this.offsetWidth), Math.round(i / 280 * 100) / 100);
        ...
        var t = F({
            ...
            s: i,
            b: o
        }), e / 360 * 180), o = 180 - o / 100 * 180 - 3, i = i / 100 * 260 - 3;
        this.elemPicker.find("." + B).css("top", e), this.elemPicker.find("." + I)[0].style.background = "#" + t, this.elemPicker.find("." + M).css({
            top: o,
            left: i
        });
    }, d.prototype.pickerEvents = function() {
        var c = this, a = c.config, s = c.elemColorBox.find("." + C), d = c.elemPicker.find("." + T + " input"), o = {
            clear: function(e) {
            ...
            confirm: function(e, i) {
                var o, r, t, n, l = d.val();
                if (-1 < l.indexOf(",") ? (r = Y(L(l)), c.select(r.h, r.s, r.b), s[0].style.background = o = "#" + F(r), 3 < (l.match(/[0-9]{1,3}/g) || []).length && "rgba" === s.attr("lay-type") && (t = 280 * l.slice(l.lastIndexOf(",") + 1, l.length - 1), c.elemPicker.find("." + E).css("left", t), o = s[0].style.background = l)) : (3 === (t = -1 < (t = l).indexOf("#") ? t.substring(1) : t).length && (t = (n = t.split(""))[0] + n[0] + n[1] + n[1] + n[2] + n[2]), n = {
...
layui.define("jquery", function(t) {
    "use strict";
    var u = layui.$, d = (layui.hint(), layui.device()), o = "element", c = "layui-this", y = "layui-show", s = ".layui-tab-title", i = function() {
        this.config = {};
        ...
        var a, t = u(".layui-tab[lay-filter=" + t + "]"), e = t.children(s), l = e.children(".layui-tab-bar"), t = t.children(".layui-tab-content"), n = "<li" + (a = [], layui.each(i, function(t, i) {
    ...
    }, ".layui-nav"), f = "layui-nav-item", l = "layui-nav-bar", p = "layui-nav-tree", b = "layui-nav-child", v = "layui-nav-more", m = "layui-anim layui-anim-upbit", C = {
        tabClick: function(t) {
            var i = (t = t || {}).options || {}, a = t.liElem || u(this), e = i.headerElem ? a.parent() : a.parents(".layui-tab").eq(0), i = i.bodyElem ? u(i.bodyElem) : e.children(".layui-tab-content").children(".layui-tab-item"), l = a.find("a"), l = "javascript:;" !== l.attr("href") && "_blank" === l.attr("target"), n = "string" == typeof a.attr("lay-unselect"), s = e.attr("lay-filter"), t = "index" in t ? t.index : a.parent().children("li").index(a);
        ...
        tabDelete: function(t, i) {
            var i = i || u(this).parent(), a = i.index(), e = i.closest(".layui-tab"), l = e.children(".layui-tab-content").children(".layui-tab-item"), n = e.attr("lay-filter");
        ...
        tabAuto: function() {
            ...
            u(".layui-tab").each(function() {
                var t = u(this), i = t.children(".layui-tab-title"), a = (t.children(".layui-tab-content").children(".layui-tab-item"), 'lay-stope="tabmore"'), a = u('<span class="layui-unselect layui-tab-bar" ' + a + "><i " + a + ' class="layui-icon">&#xe61a;</i></span>');
        ...
        clickThis: function() {
            var t = u(this), i = t.parents(h), a = i.attr("lay-filter"), e = t.parent(), l = t.siblings("." + b), n = "string" == typeof e.attr("lay-unselect");
        ...
        collapse: function() {
            var t = u(this), i = t.find(".layui-colla-icon"), a = t.siblings(".layui-colla-content"), e = t.parents(".layui-collapse").eq(0), l = e.attr("lay-filter"), n = "none" === a.css("display");
...
layui.define([
    ...
    w.prototype.config = {
        ...
        var e = this, t = e.config, i = e.elemFile = y([
            '<input class="' + a + '" type="file" accept="' + t.acceptMime + '" name="' + t.field + '"',
            t.multiple ? " multiple" : "",
            ">"
        ].join("")), n = t.elem.next();
        ...
        var i, e = this.config, t = y('<iframe id="' + b + '" class="' + b + '" name="' + b + '" frameborder="0"></iframe>'), n = y([
            '<form target="' + b + '" class="' + o + '" method="post" key="set-mine" enctype="multipart/form-data" action="' + e.url + '">',
            "</form>"
        ].join(""));
        ...
        var n = this, a = n.config, o = function(e) {
            ...
            var i = n.elemFile, e = (a.item || a.elem, 1 < e.length ? e.length + "个文件" : (e[0] || {}).name || i[0].value.match(/[^\/\\]+\..+/g) || []);
...
layui.define([
    ...
    "use strict";
    var b = layui.$, h = layui.layer, d = layui.util, l = layui.hint(), w = (layui.device(), "form"), o = ".layui-form", T = "layui-this", $ = "layui-hide", F = "layui-disabled", t = function() {
        this.config = {
            verify: {
                required: [
                    /[\S]+/,
        ...
        var i = this.config, a = b(o + (t ? '[lay-filter="' + t + '"]' : "")), n = {
            input: function(e) {
                ...
                i.autocomplete && e.attr("autocomplete", i.autocomplete), a.find("input[lay-affix],textarea[lay-affix]").each(function() {
                    var l = b(this), r = l.attr("lay-affix"), s = "layui-input-suffix", o = "layui-input-affix", e = l.is("[disabled]") || l.is("[readonly]"), c = function(e, t) {
                        (e = b(e))[0] && e[b.trim(t) ? "removeClass" : "addClass"]($);
                    }, n = function(t) {
                        t = b.extend({}, u[r] || {
                            value: r
                        }, t, lay.options(l[0]));
                        var i = b('<div class="' + o + '">'), e = b('<i class="layui-icon layui-icon-' + t.value + (t.disabled ? " " + F : "") + '"></i>'), a = (i.append(e), t.split && i.addClass("layui-input-split"), l.next("." + o)), n = (a[0] && a.remove(), l.next("." + s));
            ...
            select: function(e) {
                var v, c = "请选择", m = "layui-form-select", g = "layui-select-title", x = "layui-select-none", k = "", e = e || a.find("select"), C = function(e, t) {
                    b(e.target).parent().hasClass(g) && !t || (b("." + m).removeClass(m + "ed " + m + "up"), v && k && v.val(k)), v = null;
                }, u = function(a, e, t) {
                    var s, r, i, n, o, l, c = b(this), u = a.find("." + g), d = u.find("input"), f = a.find("dl"), h = f.children("dd"), y = f.children("dt"), p = this.selectedIndex;
                ...
                e.each(function(e, t) {
                    ...
                    var s, o = "string" == typeof i.attr("lay-search"), t = t && !t.value && t.innerHTML || c, r = b([
                        '<div class="' + (o ? "" : "layui-unselect ") + m,
                        (n ? " layui-select-disabled" : "") + '">',
                        '<div class="' + g + '">',
                        '<input type="text" placeholder="' + d.escape(b.trim(t)) + '" value="' + d.escape(b.trim(l ? r.html() : "")) + '"' + (!n && o ? "" : " readonly") + ' class="layui-input' + (o ? "" : " layui-unselect") + (n ? " " + F : "") + '">',
                        ...
                        }), 0 === s.length && s.push('<dd lay-value="" class="' + F + '">没有选项</dd>'), s.join("") + "</dl>"),
                        "</div>"
                    ].join(""));
            ...
            checkbox: function(e) {
                ...
                }, e = e || a.find("input[type=checkbox]"), c = {
                    primary: !0,
                    tag: !0,
                    "switch": !0
                };
                e.each(function(e, t) {
                    var i = b(this), a = i.attr("lay-skin") || "primary", n = b.trim(t.title || (t.title = i.attr("lay-text") || "")), l = this.disabled, n = "switch" === a ? n.split("|") : [
                        n
                    ], r = o[a = c[a] ? a : "primary"] || o.checkbox;
                    if ("string" == typeof i.attr("lay-ignore")) return i.show();
                    var s = i.next("." + r[0]), t = b([
                        ...
                        (l = {
                            checkbox: [
                                ...
                                '<i class="layui-icon ' + ("primary" === a && !t.checked && i.get(0).indeterminate ? o.SUBTRA : "layui-icon-ok") + '"></i>'
                            ].join(""),
            ...
            radio: function(e) {
                ...
                e.each(function(e, t) {
                    ...
                    n = b([
                        ...
                        "<div>" + (a = d.escape(t.title || ""), a = "string" == typeof i.next().attr("lay-radio") ? i.next().html() : a) + "</div>",
                        "</div>"
                    ].join(""));
                    i.after(n), (function(a) {
                        var n = b(this), l = "layui-anim-scaleSpring";
                        a.on("click", function() {
                            var e = n[0].name, t = n.parents(o), i = n.attr("lay-filter"), e = t.find("input[name=" + e.replace(/(\.|#|\[|\])/g, "\\$1") + "]");
        ...
        return !(e = b(e))[0] || (e.attr("lay-verify") !== undefined || !1 !== this.validate(e.find("*[lay-verify]"))) && (layui.each(e, function(e, r) {
            ...
            if (s.removeClass(f), layui.each(t, function(e, t) {
                var i = "", a = d[t];
                if (a) {
                    var n = "function" == typeof a ? i = a(c, r) : !a[0].test(c), l = "select" === r.tagName.toLowerCase() || /^(checkbox|radio)$/.test(r.type), i = i || a[1];
        ...
        var i = b(this), e = "string" == typeof e ? e : i.attr("lay-filter"), a = this.getFormElem ? this.getFormElem(e) : i.parents(o).eq(0), n = a.find("*[lay-verify]");
...
layui.define([
    ...
    "use strict";
    var p = layui.$, r = layui.lay, m = layui.laytpl, z = layui.laypage, h = layui.layer, f = layui.form, v = layui.util, u = layui.hint(), g = layui.device(), b = {
        config: {
        ...
        var t = this.config || {}, a = (e = e || {}).item3, i = e.content, t = (("escape" in a ? a : t).escape && (i = v.escape(i)), e.text && a.exportTemplet || a.templet || a.toolbar);
    ...
    }, w = "table", t = ".layui-table", T = "layui-hide", L = "layui-hide-v", N = "layui-none", R = "layui-table-view", o = ".layui-table-header", _ = ".layui-table-body", A = ".layui-table-pageview", D = ".layui-table-sort", W = "layui-table-edit", E = "layui-table-hover", M = "laytable-cell-group", j = "layui-table-col-special", H = "layui-table-tool-panel", S = "LAY_TABLE_MOVE_DICT", a = function(e) {
        return [
        ...
        "{{# } }}",
        "</style>"
    ].join(""), I = p(window), F = p(document), n = function(e) {
        ...
        n.addClass((l = [
            ...
            "layui-form",
            "layui-border-box"
        ], a.className && l.push(a.className), l.join(" "))).attr({
        ...
        var c = function(a, e, i, l) {
            ...
            l ? (l.key = [
                ...
                a,
                i
            ].join("-"), l.hide = l.hide || !1, l.colspan = l.colspan || 0, l.rowspan = l.rowspan || 0, d.initOpts(l), (n = a + (parseInt(l.rowspan) || 1)) < r.cols.length ? (l.colGroup = !0, o = 0, layui.each(r.cols[n], function(e, t) {
                t.HAS_PARENT || 1 <= o && o == (l.colspan || 1) || (t.HAS_PARENT = !0, t.parentKey = [
                    r.index,
                    a,
                    i
                ].join("-"), o += parseInt(1 < t.colspan ? t.colspan : 1), c(n, r.cols[n], e, t));
        ...
        ].join(""), a = this.layTool.find(".layui-table-tool-temp"), i = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = p(e.toolbar).html() || "") && a.html(m(t).render(e)), {
            filter: {
                title: "筛选列",
        ...
        return l = l || 1, layui.each(t, function(o, d) {
            ...
            "array" === layui.type(d) && 0 === d.length || (d[b.config.numbersName] = s, a || (d[b.config.indexName] = o), y.eachCols(function(e, l) {
                ...
                n !== undefined && null !== n || (n = ""), l.colGroup || (t = [
                    '<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(d) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + v.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(T), l.field || t.push(j), t.join(" ")) + '">',
                    '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + (e = [], l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ">" + function() {
                        var e, t = p.extend(!0, {
                            LAY_COL: l
                        }, d), a = b.config.checkName, i = b.config.disabledName;
                        switch(l.type){
                            case "checkbox":
                        ...
                        return l.toolbar ? m(p(l.toolbar).html() || "").render(t) : C.call(y, {
                            item3: l,
                            content: n,
                            tplData: t
                        });
                    ...
                    "</div></td>"
                ].join(""), i.push(t), l.fixed && "right" !== l.fixed && r.push(t), "right" === l.fixed && c.push(t));
        ...
        var a = this, i = a.config, t = e.res, l = e.curr, n = e.count, o = e.sort, d = t[i.response.dataName] || [], t = t[i.response.totalRowName], r = [], c = [], s = [], y = function() {
        ...
        c.totalRow && (layui.each(e, function(e, i) {
            ...
            var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2, l = s[e] ? parseFloat(s[e] || 0).toFixed(l) : "", l = (a = t.totalRowText || "", (n = {
                LAY_COL: t
                ...
                '<td data-field="' + e + '" data-key="' + t.key + '" ' + (a = [], t.minWidth && a.push('data-minwidth="' + t.minWidth + '"'), t.maxWidth && a.push('data-maxwidth="' + t.maxWidth + '"'), a.join(" ")) + ' class="' + (n = [], t.hide && n.push(T), t.field || n.push(j), n.join(" ")) + '">',
                '<div class="layui-table-cell laytable-cell-' + (a = t.key, "normal" === t.type ? a : a + " laytable-cell-" + t.type) + '"' + (n = [], t.align && n.push('align="' + t.align + '"'), t.style && n.push('style="' + t.style + '"'), n.join(" ")) + ">" + ("string" == typeof (a = t.totalRow || c.totalRow) ? m(a).render(p.extend({
                    TOTAL_NUMS: i || s[e],
                    TOTAL_ROW: o || {},
                    LAY_COL: t
                }, t)) : l),
        ...
        t.sortKey = {
            ...
            field: d,
            type: l.type
        }, layui.event.call(l.field, w, "sort(" + n + ")", p.extend({
            config: i
        }, i.initSort)));
    }, n.prototype.loading = function(e) {
        var t = this;
        t.config.loading && (e ? (t.layInit && t.layInit.remove(), delete t.layInit, t.layBox.find(".layui-table-init").remove()) : (t.layInit = p([
        ...
        var e = this, t = e.layMain.children("table"), a = e.layMain.width() - e.layMain.prop("clientWidth"), i = e.layMain.height() - e.layMain.prop("clientHeight"), l = (e.getScrollWidth(e.layMain[0]), t.outerWidth() - e.layMain.width()), n = function(e) {
            var t;
        ...
        var s = this, y = s.config, r = y.elem.attr("lay-filter"), e = s.layHeader.find("th"), u = ".layui-table-cell", o = p("body"), d = {}, n = (s.layTool.on("click", "*[lay-event]", function(e) {
            ...
            switch(layui.stope(e), F.trigger("table.tool.panel.remove"), h.close(s.tipsIndex), t){
                ...
                case "LAYTABLE_EXPORT":
                    g.ie ? h.tips("导出功能不支持 IE，请用 Chrome 等高级浏览器导出", this, {
                        tips: 3
                    }) : l({
                        list: [
                    ...
                    break;
                case "LAYTABLE_PRINT":
                    var n = window.open("about:blank", "_blank"), o = [
                        "<style>",
            ...
            layui.event.call(this, w, "toolbar(" + r + ")", p.extend({
                event: t,
                config: y
            }, {}));
        }), s.layPagebar.on("click", "*[lay-event]", function(e) {
            var t = p(this).attr("lay-event");
            layui.event.call(this, w, "pagebar(" + r + ")", p.extend({
                event: t,
                config: y
            }, {}));
            ...
            var t, a = p(this);
            d.allowResize && (t = a.data("key"), e.preventDefault(), d.offset = [
                e.clientX,
                e.clientY
            ...
            x.eventMoveElem && (i = (t = x.eventMoveElem).closest("." + R).attr("lay-id"), (a = k(i)) && (i = t.data("key"), l = a.col(i), n = a.config.elem.attr("lay-filter"), d = {}, o.css("cursor", ""), a.scrollPatch(), t.removeData(S), delete x.eventMoveElem, a.getCssRule(i, function(e) {
                l.width = parseFloat(e.style.width), layui.event.call(t[0], w, "colResized(" + n + ")", {
                    col: l,
                    config: a.config
                });
            })));
            ...
            var t = p(this).parents("tr").eq(0).data("index"), r = s.layBody.find('tr[data-index="' + t + '"]'), c = (c = b.cache[s.key] || [])[t] || {}, a = {
                tr: r,
                config: y,
            ...
            var e = p(this).prev(), t = s.layBody.find('input[name="layTableCheckbox"]'), a = e.parents("tr").eq(0).data("index"), i = e[0].checked, l = "layTableAllChoose" === e.attr("lay-filter");
            ...
            e[0].disabled || (s.setRowChecked({
                type: "radio",
                index: a
            }), layui.event.call(e[0], w, "radio(" + r + ")", n.call(e[0], {
                checked: t
            })));
            ...
            var e = p(this), t = e.parent(), a = this.value, i = e.parent().data("field"), e = e.closest("tr").data("index"), e = b.cache[s.key][e], l = n.call(t[0], {
                value: a,
                field: i,
                oldValue: e[i],
                td: t,
            ...
            s.tipsIndex = h.tips([
                '<div class="layui-table-tips-main" style="margin-top: -' + (t.height() + 23) + "px;" + ("sm" === y.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === y.size ? "padding: 14px 15px;" : "") + '">',
                t.html(),
                "</div>",
            ...
            layui.event.call(this, w, (e || "tool") + "(" + r + ")", n.call(this, {
        ...
        o = o || {};
        var e = "object" == typeof i ? i : p("string" == typeof i ? 'table[lay-filter="' + i + '"]' : t + "[lay-data], " + t + "[lay-options]"), d = "Table element property lay-data configuration item has a syntax error: ";
        return e.each(function() {
            var l, e = p(this), t = e.attr("lay-data"), t = r.options(this, {
                ...
                n.cols[i] = [], p(this).children().each(function(e) {
                    var t = p(this), a = t.attr("lay-data"), a = r.options(this, {
    ...
    b.eachCols = function(e, a, i) {
        ...
        var o, d, i, r, l = (a = "object" == typeof a ? a : (l = {}, a && (l.type = a), l)).type || "csv", c = x.that[e], n = x.config[e] || {}, s = {
            csv: "text/csv",
            xls: "application/vnd.ms-excel"
        }[l], y = document.createElement("a");
        ...
        var a = p.extend([], arguments), i = (a[3] = "reloadData", new RegExp("^(" + [
            "elem",
            "id",
            "cols",
            "width",
...
layui.define([
    ...
    }, L = ".layui-table-main", j = ".layui-table-fixed-l", P = ".layui-table-fixed-r", B = "LAY_DATA_INDEX", h = "LAY_DATA_INDEX_HISTORY", f = "LAY_PARENT_INDEX", s = "LAY_CHECKBOX_HALF", F = "LAY_EXPAND", X = "LAY_HAS_EXPANDED", t = function(e) {
        var t = this;
    ...
    t.prototype.init = function() {
        var i = this, e = i.config, t = Y.render(O.extend({}, e, {
            data: [],
            url: "",
            done: null
        })), l = t.config.id, a = ((o.that[l] = i).tableIns = t, e.tree), t = a.customName, r = (t.isParent, t.children), n = e.parseData, d = e.done;
        e.url ? e.parseData = function() {
            ...
            var e, t = arguments, a = this.elem.next(), n = (i.updateStatus(null, {
                LAY_HAS_EXPANDED: !1
            }), c(l, r), a.find('[name="layTableCheckbox"][lay-filter="layTableAllChoose"]'));
    ...
    var U = function(t, a, n, i, l) {
        var e = t.trElem, r = e.closest(".layui-table-view"), d = (r.attr("lay-filter"), r.attr("lay-id")), o = Y.getOptions(d), c = o.tree || {}, u = c.customName || {}, f = u.isParent, s = e.attr("lay-data-index"), y = E(d), p = (y.getTableData(), y.getNodeDataByIndex(s)), h = (e.data("level") || 0) + 1, x = "boolean" !== layui.type(a), e = x ? !p[F] : a, m = p[f] ? e : null;
        ...
        var b = p[X], g = r.find('tr[lay-data-index="' + s + '"]'), v = g.find(".layui-table-tree-flexIcon"), f = (v.html(e ? c.view.flexIconOpen : c.view.flexIconClose), p[f] && v.css("visibility", "visible"), c.view.showIcon && p[f] && !p.icon && !c.view.icon && g.find(".layui-table-tree-nodeIcon").html(e ? c.view.iconOpen : c.view.iconClose), p[u.children] || []);
        if (e) {
            if (b) p[F] = e, r.find(f.map(function(e, t, a) {
                return 'tr[lay-data-index="' + e[B] + '"]';
            }).join(",")).removeClass("layui-hide"), layui.each(f, function(e, t) {
                n && !x ? U({
                    trElem: r.find('tr[lay-data-index="' + t.LAY_DATA_INDEX + '"]').first()
                }, a, n, i, l) : t[F] && U({
                    trElem: r.find('tr[lay-data-index="' + t.LAY_DATA_INDEX + '"]').first()
                }, !0);
            });
        ...
        var a = this.getOptions(), n = a.elem.next(), i = (n.addClass("layui-table-tree"), a.id), r = a.tree || {}, d = (r.data, r.view || {}), a = r.customName || {}, o = a.isParent, c = n.attr("lay-filter"), u = this, f = ((l = l || 0) || (n.find(".layui-table-body tr:not([data-level])").attr("data-level", l), layui.each(Y.cache[i], function(e, t) {
        ...
        layui.each(e.find('td[data-field="' + a + '"]'), function(e, t) {
            ...
            i.hasClass("layui-table-tree-item") || (i.addClass("layui-table-tree-item"), (i = n.attr("lay-data-index")) && ((a = u.getNodeDataByIndex(i))[F] && (f[i] = !0), i = t.find("div.layui-table-cell").html(), t.find("div.layui-table-cell").html([
                '<div class="layui-inline layui-table-tree-flexIcon" ',
                'style="',
                "margin-left: " + s * l + "px;",
                a[o] || d.showFlexIconIfNotParent ? "" : " visibility: hidden;",
                '">',
            ...
            e.find(".layui-table-tree-flexIcon").html(r.view.flexIconOpen), U({
                trElem: e.first()
            }, !0);
        ...
        var t, a, n = E(e);
        n && (a = (t = n.getOptions()).initSort, t.url || (a.type ? t.data = layui.sort(t.data, a.field, "desc" === a.type) : t.data = layui.sort(t.data, Y.config.indexName), n.initData(t.data), p.reloadData(e)));
    }, function(t) {
        ...
        var n, i, l, r, d = E(e);
        d && ((l = d.getOptions()).tree, l = (n = l.elem.next()).find('tr[lay-data-index="' + a + '"]'), i = l.attr("data-index"), l = l.attr("data-level"), t && (t = d.getNodeDataByIndex(a, !1, t), r = Y.getTrHtml(e, [
            t
        ]), layui.each([
            "main",
            "fixed-l",
            ...
            n.find(".layui-table-" + t + ' tbody tr[lay-data-index="' + a + '"]').replaceWith(O(r[[
                "trs",
                "trs_fixed",
                "trs_fixed_r"
            ][e]].join("")).attr({
        ...
        var a, n, i, l, r = E(e);
        r && (l = (i = r.getOptions()).tree, a = i.elem.next(), n = [], i = r.getNodeDataByIndex("string" === layui.type(t) ? t : t[B], !1, "delete"), t = r.getNodeDataByIndex(i[f]), r.updateCheckStatus(t, !0), t = r.treeToFlat([
            i
        ], i[l.customName.pid], i[f]), layui.each(t, function(e, t) {
            n.push('tr[lay-data-index="' + t[B] + '"]');
        }), a.find(n.join(",")).remove(), l = r.initData(), layui.each(r.treeToFlat(l), function(e, t) {
            t[h] && t[h] !== t[B] && a.find('tr[lay-data-index="' + t[h] + '"]').attr({
                "data-index": t[B],
                "lay-data-index": t[B]
            });
        ...
        if (y) return u = y.getOptions(), f = u.tree, a = u.elem.next(), s = (t = t || {}).parentIndex, i = t.index, l = t.data, t = t.focus, n = (s = "number" === layui.type(s) ? s.toString() : s) ? y.getNodeDataByIndex(s) : null, i = "number" === layui.type(i) ? i : -1, l = O.extend(!0, [], layui.isArray(l) ? l : [
            l
        ]), y.getTableData(), n ? (r = f.customName.isParent, f = f.customName.children, n[r] = !0, c = (c = n[f]) ? (d = c.splice(-1 === i ? c.length : i), n[f] = c.concat(l, d)) : n[f] = l, y.updateStatus(c, function(e) {
            e[r] && (e[X] = !1);
        }), f = y.treeToFlat(c), a.find(f.map(function(e) {
            return 'tr[lay-data-index="' + e[B] + '"]';
        }).join(",")).remove(), y.initData(), n[X] = !1, n.LAY_ASYNC_STATUS = "local", U({
            trElem: a.find('tr[lay-data-index="' + s + '"]')
        }, !0)) : (d = Y.cache[e].splice(-1 === i ? Y.cache[e].length : i), Y.cache[e] = Y.cache[e].concat(l, d), u.url || (u.page ? (c = u.page, u.data.splice.apply(u.data, [
            c.limit * (c.curr - 1),
            c.limit
        ].concat(Y.cache[e]))) : u.data = Y.cache[e]), y.initData(), f = Y.getTrHtml(e, l), o = {
            trs: O(f.trs.join("")),
        ...
        if (E(e)) return t = p.getData(e, !0).filter(function(e, t, a) {
            ...
            if (!t[Y.config.checkName]) return a = !1, true;
        }), {
            data: t,
            isAll: a
        };
        ...
        t.id;
        a.hasClass("layui-table-tree") && (n(e), (t.tree || {}).view.dblClickExpand && U({
            trElem: e.tr.first()
        }, null, null, null, !0));
        ...
        var a = this.getOptions(), n = (a.tree, a.id), i = a.elem.next(), l = Y.config.checkName, r = (e && (a = this.updateParentCheckStatus(e, t), layui.each(a, function(e, t) {
        ...
        var n = this, i = n.getOptions(), l = i.id, r = i.elem.next(), d = (e.length ? e : r).find(".laytable-cell-radio, .laytable-cell-checkbox").children("input").last(), o = "radio" === d.attr("type");
        if (a) {
            a = function() {
                var e = function(e) {
                    layui.stope(e);
            ...
            if (!o) return i.tree.customName.isParent, t = "boolean" === layui.type(t) ? t : !a[u], o = n.updateStatus(a ? [
                a
            ] : Y.cache[l], function(e) {
...
layui.define("form", function(e) {
    ...
    }, y = "layui-hide", d = "layui-disabled", f = "layui-tree-set", C = "layui-tree-iconClick", k = "layui-icon-addition", v = "layui-icon-subtraction", m = "layui-tree-entry", x = "layui-tree-main", b = "layui-tree-txt", g = "layui-tree-pack", w = "layui-tree-spread", N = "layui-tree-setLineShort", T = "layui-tree-showLine", L = "layui-tree-lineExtend", l = function(e) {
        var i = this;
    ...
    l.prototype.config = {
        ...
        var e = this, i = e.config, n = (e.checkids = [], u('<div class="layui-tree' + (i.showCheckbox ? " layui-form" : "") + (i.showLine ? " layui-tree-line" : "") + '" lay-filter="LAY-tree-' + e.index + '"></div>')), a = (e.tree(n), i.elem = u(i.elem));
        if (a[0]) {
        ...
        layui.each(e, function(e, i) {
            var n = i.children && 0 < i.children.length, a = u('<div class="layui-tree-pack" ' + (i.spread ? 'style="display: block;"' : "") + "></div>"), t = u([
                '<div data-id="' + i.id + '" class="layui-tree-set' + (i.spread ? " layui-tree-spread" : "") + (i.checked ? " layui-tree-checkedFirst" : "") + '">',
                '<div class="layui-tree-entry">',
                '<div class="layui-tree-main">',
                c.showLine ? n ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (i.spread ? "layui-icon-subtraction" : "layui-icon-addition") + '"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-icon layui-icon-file"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (n ? "" : y) + '"></i></span>',
                c.showCheckbox ? '<input type="checkbox" name="' + (i.field || "layuiTreeCheck_" + i.id) + '" same="layuiTreeCheck" lay-skin="primary" ' + (i.disabled ? "disabled" : "") + ' value="' + i.id + '">' : "",
                c.isJump && i.href ? '<a href="' + i.href + '" target="_blank" class="' + b + '">' + (i.title || i.label || c.text.defaultNodeName) + "</a>" : '<span class="' + b + (i.disabled ? " " + d : "") + '">' + (i.title || i.label || c.text.defaultNodeName) + "</span>",
                "</div>",
                function() {
                    if (!c.edit) return "";
                    var n = {
        ...
        var t = this.config, i = a.children("." + m), n = i.children("." + x), l = i.find("." + C), i = i.find("." + b), r = t.onlyIconControl ? l : n, c = "";
        ...
        e.children(".layui-tree-btnGroup").on("click", ".layui-icon", function(e) {
            ...
            if ("add" == e) {
                ...
                if (r.title = o.text.defaultNodeName, r.id = l, s.tree(c.children("." + g), [
                    r
                ]), o.showLine && (a[0] ? (a.hasClass(L) || a.addClass(L), c.find("." + g).each(function() {
...
layui.define([
    ...
    }, s = "layui-hide", h = "layui-btn-disabled", r = "layui-none", c = "layui-transfer-box", u = "layui-transfer-header", o = "layui-transfer-search", f = "layui-transfer-data", y = function(e) {
        return [
    ...
    v.prototype.config = {
        ...
        var e = this, t = e.config, a = e.elem = d(n(p, {
            open: "{{",
            close: "}}"
        }).render({
            data: t,
        ...
        e.parseData(function(e) {
            var t = e.selected ? 1 : 0, a = [
                "<li>",
                '<input type="checkbox" name="' + i[t].checkName + '" lay-skin="primary" lay-filter="layTransferCheckbox" title="' + e.title + '"' + (e.disabled ? " disabled" : "") + (e.checked ? " checked" : "") + ' value="' + e.value + '">',
                "</li>"
            ].join("");
        ...
        r = r || {}, c.layBox.each(function(e) {
            var t = d(this), a = t.find("." + f), t = t.find("." + u).find('input[type="checkbox"]'), i = a.find('input[type="checkbox"]'), n = 0, l = !1;
            i.each(function() {
        ...
        var a, i = this, n = i.config, l = i.layBox.eq(e), r = [], t = (t ? ((a = t.find('input[type="checkbox"]'))[0].checked = !1, l.siblings("." + c).find("." + f).append(t.clone()), t.remove(), r.push(a[0].value), i.setValue()) : l.each(function(e) {
        ...
        n.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function() {
            ...
            var i = this.value, e = d(this).parents("." + o).eq(0).siblings("." + f), t = e.children("li"), t = (t.each(function() {
                var e = d(this), t = e.find('input[type="checkbox"]'), a = t[0].title, a = ("cs" !== l.showSearch && (a = a.toLowerCase(), i = i.toLowerCase()), -1 !== a.indexOf(i));
...
layui.define([
    ...
    }), r = "carousel", d = "layui-this", s = "layui-carousel-left", u = "layui-carousel-right", c = "layui-carousel-prev", m = "layui-carousel-next", l = "layui-carousel-arrow", f = "layui-carousel-ind", i = function(e) {
        var i = this;
    ...
    i.prototype.config = {
        ...
        var i = this, e = i.config, n = a([
            '<button class="layui-icon ' + l + '" lay-type="sub">' + ("updown" === e.anim ? "&#xe619;" : "&#xe603;") + "</button>",
            '<button class="layui-icon ' + l + '" lay-type="add">' + ("updown" === e.anim ? "&#xe61a;" : "&#xe602;") + "</button>"
        ].join(""));
        ...
        var i, e = this, n = e.config, t = e.elemInd = a([
            '<div class="' + f + '"><ul>',
            (i = [], layui.each(e.elemItem, function(e) {
...
layui.define([
    ...
    }, l = "rate", f = "layui-icon-rate", h = "layui-icon-rate-solid", o = "layui-icon-rate-half", u = "layui-icon-rate-solid layui-icon-rate-half", v = "layui-icon-rate layui-icon-rate-half", a = function(e) {
        var a = this;
...
layui.define("jquery", function(l) {
    ...
    e.prototype.load = function(l) {
        ...
        var e, c = this, m = 0, s = g((l = l || {}).scrollElem || document), u = l.elem || "img", f = l.scrollElem && l.scrollElem !== document, y = function(e, l) {
            ...
            else for(var n = 0; n < c.lazyimg.elem.length; n++){
...
layui.define([
    ...
    e("code", function(e) {
        ...
        e.elem = M(e.elem), e.elem[0] && layui.each(e.elem.get().reverse(), function(e, a) {
            var i, l, t, s, o, n, d, c, r, u, E = M(a), y = M.extend(!0, {}, L, lay.options(a), (i = {}, layui.each([
                "title",
                "height",
                "encode",
                "skin",
                ...
                l.push(I(this.value));
            }), 0 === l.length && l.push(I(E.html())), l), f = (E.data("code", v), y.preview && (a = "LAY-CODE-DF-" + e, t = y.layout || [
                "code",
                "preview"
            ], s = "iframe" === y.preview, h = M('<div class="' + b.ELEM_PREVIEW + '">'), u = M('<div class="layui-tab layui-tab-brief">'), o = M('<div class="layui-tab-title">'), n = M('<div class="' + [
                b.ELEM_ITEM,
                b.ELEM_ITEM + "-preview",
                "layui-border"
            ].join(" ") + '">'), d = M('<div class="layui-code-tools"></div>'), m = E.parent("." + b.ELEM_PREVIEW), f = E.prev("." + b.ELEM_TAB), p = E.next("." + b.ELEM_ITEM + "-preview"), y.id && h.attr("id", y.id), h.addClass(y.className), u.attr("lay-filter", a), layui.each(t, function(e, a) {
                var l = M('<li lay-id="' + a + '">');
                ...
                full: {
                    ...
                    event: function(e, a) {
                        var l = e.closest("." + b.ELEM_PREVIEW), i = "layui-icon-" + this.className, t = "layui-icon-screen-restore", s = this.title, o = M("html,body"), n = "layui-scollbar-hide";
            ...
            }, "preview" === t[0] ? (n.addClass(b.ELEM_SHOW), E.before(n), r(n)) : E.addClass(b.ELEM_SHOW).after(n), y.codeStyle = [
                y.style,
                y.codeStyle
            ].join(""), y.previewStyle = [
                y.style,
                y.previewStyle
            ].join(""), n.attr("style", y.previewStyle), w.on("tab(" + a + ")", function(e) {
            ...
            })), y.ln ? "ol" : "ul"), p = M("<" + f + ' class="layui-code-' + f + '">'), m = M('<div class="' + b.ELEM_TITLE + '">'), h = (E.addClass("layui-code-view layui-box"), y.skin && ("notepad" === y.skin && (y.skin = "dark"), E.removeClass("layui-code-dark layui-code-light"), E.addClass("layui-code-" + y.skin)), _.escape(v.join(""))), h = (h = y.encode ? _.escape(h) : h).replace(/[\r\t\n]+/g, "</li><li>");
...
//# sourceMappingURL=index.4e992922.js.map
